...
src_prepare() {
	...
	use kpscript && if has_version ">=dev-lang/mono-4" ; then
		sed -i -e 's! ToolsVersion="3.5"!!g' Ext/Plugins/KPScript.csproj || die
		sed -i -e 's/Format Version 10.00/Format Version 11.00/' Ext/Plugins/KPScript.sln || die
	fi
